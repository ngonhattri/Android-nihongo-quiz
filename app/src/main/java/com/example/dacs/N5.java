...
public class N5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getSupportActionBar().setTitle("Danh sách đề thi N5");
        addControls();
        addEvents();
    ...
    private void addEvents() {
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                if (tabId.equals("t1"))
                {
                    Toast.makeText(N5.this,"Bạn Chọn Bộ Đề Hán Tự",Toast.LENGTH_LONG).show();
                }
                else if(tabId.equals("t2"))
                {
                    Toast.makeText(N5.this,"Bạn Chọn Bộ Đề Từ Vựng",Toast.LENGTH_LONG).show();
                }
                else if(tabId.equals("t3"))
                {
                    Toast.makeText(N5.this,"Bạn Chọn Bộ Đề Ngữ Pháp",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void addControls() {
        ...
        arr_exam.add(new Dethi("Bài 2"));
        arr_exam.add(new Dethi("Bài 3"));
        ...
        dethivuaAdapter= new DethiAdapter(N5.this,arr_examVua);
        ...
        dethikhoAdapter= new DethiAdapter(N5.this,arr_examKho);
