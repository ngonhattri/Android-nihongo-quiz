...
public class N2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getSupportActionBar().setTitle("Danh sách đề thi N2");
        addControls();
        addEvents();
    ...
    private void addEvents() {
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                if (tabId.equals("t1"))
                {
                    Toast.makeText(N2Activity.this,"Bạn Chọn Bộ Đề Hán Tự",Toast.LENGTH_LONG).show();
                }
                else if(tabId.equals("t2"))
                {
                    Toast.makeText(N2Activity.this,"Bạn Chọn Bộ Đề Từ Vựng",Toast.LENGTH_LONG).show();
                }
                else if(tabId.equals("t3"))
                {
                    Toast.makeText(N2Activity.this,"Bạn Chọn Bộ Đề Ngữ Pháp",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void addControls() {
        ...
        dethiAdapter= new DethiAdapter(N2Activity.this,arr_exam);
        lvExam.setAdapter(dethiAdapter);
        lvExam.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(N2Activity.this, ScreenSlideActivity.class);
        ...
        dethivuaAdapter= new DethiAdapter(N2Activity.this,arr_examVua);
        ...
        dethikhoAdapter= new DethiAdapter(N2Activity.this,arr_examKho);
